    ...
    , ui(new Ui::Widget)
{
    ...
    //Shape
    ui->shapeCombobox->addItem(tr("Polygon"), ShapeCanvas::Polygon);
    ui->shapeCombobox->addItem(tr("Rectangle"), ShapeCanvas::Rect);
    ui->shapeCombobox->addItem(tr("Rounded Rectangle"), ShapeCanvas::RoundedRect);
    ui->shapeCombobox->addItem(tr("Ellipse"), ShapeCanvas::Ellipse);
    ui->shapeCombobox->addItem(tr("Pie"), ShapeCanvas::Pie);
    ui->shapeCombobox->addItem(tr("Chord"), ShapeCanvas::Chord);
    ui->shapeCombobox->addItem(tr("Text"), ShapeCanvas::Text);
    ui->shapeCombobox->addItem(tr("Pixmap"), ShapeCanvas::Pixmap);
...
void Widget::on_shapeCombobox_activated(int index)
{
